...
pinned: false
description: "实用脚本及命令合集 1、DD重装脚本 史上最强脚本 萌咖大佬的脚本 beta.gs大佬的脚本 DD windows（使用史上最强DD脚本） 账户：Administrator 密码：Teddysun.com 使用Windows徽标+R快捷键打开运行框，输入powershell运行，弹出powershe"
tags: [VPS]
category: 技术
draft: false
---
...
### 硬件信息检测
```bash
curl -sL https://raw.githubusercontent.com/Yuri-NagaSaki/SICK/refs/heads/main/hardware_info.sh | bash -s -
```